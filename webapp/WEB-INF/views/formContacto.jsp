...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<form:form class="form-horizontal" method="post" action="${urlRoot}contacto" modelAttribute="instanciaContacto">
			...
			<div class="form-group row">
				<label for="genero" class="col-sm-2 col-form-label">Géneros
					Favoritos</label>
				<div class="col-sm-10">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Tu experiencia en el
					sitio</label>
				<div class="col-sm-10">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Te gustaría recibir notificaciones de:</label>
				<div class="col-sm-10">
