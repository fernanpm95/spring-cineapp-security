...
<%-- 					</form:select> --%>
			...
			<div class="form-row">
				...
				<div class="form-group col-sm-3">
					<label for="fechaEstreno" class="col-form-label">Fecha
						Estreno</label>
				...
				<div class="form-group col-sm-6">
					...
					<p class="text-muted">Imagen de la pelicula</p>
				</div>
			</div>
			...
			<div class="form-row">
				...
				<div class="form-group col-sm-3">
						<label for="actores" class="col-form-label">Actores</label>
						<form:input type="text" class="form-control" path="detalle.actores"
							id="actores" required="required" />
				</div>

				<div class="form-group col-sm-6">
						<label for="trailer" class="col-form-label">URL del Trailer (Youtube)</label>
